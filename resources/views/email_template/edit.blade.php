                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card mt-5">
                                ...
                                <form action="{{ route('sms-mail.template.update', $email_template->id) }}"
                                    method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label class="font-weight-bold">@lang('Status') <span
                                                        class="text-danger">*</span></label>
                                                <input type="checkbox" data-height="46px" data-width="100%"
                                                    data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle"
                                                    data-on="@lang('Send Email')" data-off="@lang("Don't Send")"
                                                    name="email_status" @if ($email_template->email_status) checked @endif>
                                            </div>
...
@push('breadcrumb-plugins')
    <a href="{{ route('sms-mail.template') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i
