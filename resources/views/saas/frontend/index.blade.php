                        ...
                        <div class="col-md-12 col-lg-12 col-xl-8">
                            <div class="hero-content text-center position-relative">
                                ...
                                <a href="{{ route('owner.register.form') }}" class="theme-btn position-relative"
                                    title="{{ __('Get Started') }}">{{ __('Get Started') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div
                                                    ...
                                                    <h2 class="price-title mb-4">
                                                        {{ currencyPrice($package->monthly_price) }}<span
                                                            class="font-18 font-semi-bold">/monthly</span></h2>
                                                    <ul class="pricing-features">
                                                        <li class="d-flex align-items-center mb-3">
                                                            <span
                                                                class="price-check-icon flex-shrink-0 d-inline-flex align-items-center justify-content-center status-btn-blue radius-50 me-2">
                                                            ...
                                                            <span class="flex-grow-1">Manage {{ $package->max_property }}
                                                                Property</span>
                                                        </li>
                                                        <li class="d-flex align-items-center mb-3">
                                                            <span
                                                            ...
                                                            <span class="flex-grow-1">Add {{ $package->max_tenant }}
                                                                Tenant</span>
                                                        </li>
                                                        <li class="d-flex align-items-center mb-3">
                                                            <span
                                                            ...
                                                            <span>Add {{ $package->max_maintainer }} Maintainer </span>
                                                        </li>
                                                        <li class="d-flex align-items-center mb-3">
                                                            <span
                                                                class="price-check-icon flex-shrink-0 d-inline-flex align-items-center justify-content-center status-btn-blue radius-50 me-2">
                                                            ...
                                                            <span class="flex-grow-1">{{ $package->max_invoice }}
                                                                {{ __('Invoice Ganareate') }}</span>
                                                        </li>
                                                        <li class="d-flex align-items-center mb-3">
                                                            <span
                                                                class="price-check-icon flex-shrink-0 d-inline-flex align-items-center justify-content-center status-btn-blue radius-50 me-2">
                                                            ...
                                                            <span class="flex-grow-1">{{ $package->max_auto_invoice }}
                                                                {{ __('Auto Invoice Ganareate') }}</span>
                                                        </li>
                    ...
                    <div class="col-md-12">
                        <div class="integrations-logo-list">
                            <div class="integrations-logo-wrap position-relative">
                                <div class="logo-item">
                                    <img src="{{ getSettingImage('home_integration_section_image') }}" alt=""
                                        class="img-fluid">
                                </div>
                            </div>
                        </div>
